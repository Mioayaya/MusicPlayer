...
import { setPlayListId,clearAllData, delSingelSong } from '../../store/slices/play-list';
  ...
  return (
    <MioBarPlayListDiv theme={theme}>
      ...
      <div className="tips">
        ...
        <span className="clear" onClick={e => dispatch(setPlayListShow())}>收起列表</span>
      </div>
            ...
            if(item != -1) {
              return (
                ...
                >
                  ...
                  <span className="item-delete" title="删除" onClick={e => dispatch(delSingelSong(playlist[index].value.id))}>▮</span>
                </span>
              )
            }
          })
